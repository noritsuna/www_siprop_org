...
//UTF-8:case 'ko': define('MB_LANGUAGE', 'Korean'  ); break; //UTF-8 only
//UTF-8:	// See BugTrack2/13 for all hack about Korean support, //UTF-8 only
//UTF-8:	// and give us your report!                            //UTF-8 only
default: die_message('No such language "' . LANG . '"'); break;
}

//UTF-8:define('PKWK_UTF8_ENABLE', 1); //UTF-8 only
